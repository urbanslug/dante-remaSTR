...
class PostFilter:
    ...
    def quality_annotation(self, ann: annotation.Annotation, module_number: int, both_primers: bool = True) -> bool:
        """
    ...
    def get_filtered(self, annotations: list[annotation.Annotation], module_number: int,
                     both_primers: bool = True) -> tuple[list[annotation.Annotation], list[annotation.Annotation]]:
        """
