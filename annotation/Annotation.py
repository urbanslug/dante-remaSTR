...
class Annotation:
    ...
    def __get_bases_per_module(self) -> tuple[int]:
        ...
        return tuple(self.states.count(str(i)) for i in range(self.n_modules))
    ...
    def __get_module_repetitions(self) -> tuple[int]:
        ...
        return tuple([1 if reps == 1 and cnt > 0 else cnt // len(seq) for (seq, reps), cnt in zip(self.motif.get_modules(), repetitions)])
    ...
    def __get_module_sequences(self) -> tuple[str]:
        ...
        for i in range(self.n_modules):
            first = self.states.find(str(i))
            if first > -1:
                last = self.states.rfind(str(i))
