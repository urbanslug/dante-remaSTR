...
def load_arguments() -> argparse.Namespace:
    ...
    try:
        ...
        options.add_argument('--param-file', type=nonempty_file, help='Parameter file for inference of alleles. Default=MiSeq parameters', default=None)
        ...
        options.add_argument('--verbose', '-v', action='store_true', help='Print all the outputs. Default is to print only the result table to stdout.')
